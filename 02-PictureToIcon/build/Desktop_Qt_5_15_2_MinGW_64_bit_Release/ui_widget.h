...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        label_picture->setGeometry(QRect(520, 120, 200, 200));
        label_filemname = new QLabel(Widget);
        label_filemname->setObjectName(QString::fromUtf8("label_filemname"));
        label_filemname->setGeometry(QRect(250, 100, 121, 31));
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        label_filemname->setText(QString());
    } // retranslateUi
